...
//     }
// ----------------------------------------------------------------------------------------------
var Operario = /** @class */ (function () {
    function Operario(nombre, sueldo) {
        this.nombre = nombre;
        this.sueldo = sueldo;
    }
    Operario.prototype.getSueldo = function () {
        return this.sueldo;
    };
    Operario.prototype.AumentoSueldo = function () {
        var nuevoSueldo = 0;
...
var trabajador1 = new Operario("Marcos", 84000);
var trabajador2 = new Operario("Juan", 76000);
try {
